            ...
            <div className='flex flex-col mx-5'>
                <div className="grid grid-cols-2 items-center h-screen">
                    ...
                    <div>
                        ...
                        <h4 className="font-bold text-green-600 text-2xl">{product?.mealType}</h4>
                ...
                <div className="ms-40">
                    <h3 className='text-xl font-bold'>Rating : {product?.rating} <i className='fa-solid fa-star text-red-400'></i></h3>
