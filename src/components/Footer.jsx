...
const Footer = () => {
  return (
    <div style={{ marginTop: '100px' }} className=' bg-green-700 mt-45 p-5 text-white font-bold' >
      <div className='flex justify-around '>
        <div>
          <Link className='text-2xl ' to={'/'} ><i className="fa-solid fa-bowl-food me-1"></i>Wiggy</Link>
